var config = {
	sprintConfig: {
		...
		url_trello: 'https://trello.com/b/vMeeBNwb/treetech-op-fase-2-sprint-12-xxxx-14-07-a-28-07-xx-x-pontos'

		,data_inicial: '14/07/2015' // Data de início da sprint (dia 0)

		,data_final: '28/07/2015'   // Data de fechamento da sprint

		,dias_sem_jornada: []       // Dias sem jornada de trabalho (exemplo: feriados), Não é necessário informar sábados e domingos.

		,legenda_burndown: 'Sprint 12'
